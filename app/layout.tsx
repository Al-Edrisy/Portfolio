...
export const metadata: Metadata = {
  ...
  creator: "Al-Edrisy (Salih Ben Otman)",
  publisher: "Al-Edrisy",
  formatDetection: {
    email: false,
    address: false,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Al-Edrisy - Full Stack Software Developer Portfolio",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "Al-Edrisy (Salih Ben Otman) - Full Stack Software Developer",
    description:
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "url": "https://salihbenotman.dev",
        "name": "Al-Edrisy Portfolio",
        "description": "Portfolio website of Al-Edrisy (Salih Ben Otman), showcasing professional software development projects, skills, and experience.",
        "publisher": {
          "@id": "https://salihbenotman.dev/#person"
        },
        "inLanguage": "en-US",
